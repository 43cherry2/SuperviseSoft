...
{
  public sealed class ResetPasswordPanel : MonoBehaviour
  {
    ...
    public void Bind()
    {
      ...
      if (sendSmsCodeButton == null && resetPasswordButton == null && backToLoginButton == null)
      {
        return;
      }
    ...
    private void OnSendSmsCodeClicked()
    {
      ...
      StartCoroutine(AuthService.Instance.SendSmsCode(phone, "reset_password", response =>
      {
    ...
    private void OnResetPasswordClicked()
    {
      ...
      var password = newPasswordInput == null ? string.Empty : newPasswordInput.text;
      ...
      SetButtonsInteractable(false);
      StartCoroutine(AuthService.Instance.ResetPasswordWithSmsCode(phone, code, password, response =>
      {
        SetButtonsInteractable(true);
        if (response.success)
        {
    ...
    private void SetButtonsInteractable(bool value)
    {
      ...
      {
        resetPasswordButton.interactable = value;
      }
