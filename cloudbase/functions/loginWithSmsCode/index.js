...
exports.main = async (event, context) => {
  ...
  try {
    ...
    await writeLoginLog(authUid, phoneMasked, "sms_code", true, "");
    ...
    await safeWriteLoginLog(authUid, phoneMasked, "sms_code", false, error.message);
    return fail(error.code || 40001, error.message || "验证码登录失败");
  }
};
