...
exports.main = async (event, context) => {
  ...
  try {
    ...
    await writeLoginLog(authUid, phoneMasked, "password", true, "");
    ...
    await safeWriteLoginLog(authUid, phoneMasked, "password", false, error.message);
    return fail(error.code || 40001, error.message || "密码登录失败");
  }
};
